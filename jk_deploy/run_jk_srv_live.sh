...
export APP_SRV_GMSL_FOCAL="${APP_SRV_GMSL_FOCAL:-343}"
export APP_SRV_ANALOG_FOCAL="${APP_SRV_ANALOG_FOCAL:-273}"
export APP_SRV_MM_PER_LUT_PIXEL="${APP_SRV_MM_PER_LUT_PIXEL:-1.17}"
export APP_SRV_MM_PER_LUT_PIXEL_X="${APP_SRV_MM_PER_LUT_PIXEL_X:-$APP_SRV_MM_PER_LUT_PIXEL}"
export APP_SRV_MM_PER_LUT_PIXEL_Y="${APP_SRV_MM_PER_LUT_PIXEL_Y:-$APP_SRV_MM_PER_LUT_PIXEL}"
export APP_SRV_FLAT_GROUND="${APP_SRV_FLAT_GROUND:-1}"
export APP_SRV_BLEND_DEGREES="${APP_SRV_BLEND_DEGREES:-10}"
export APP_SRV_ORIGIN_X="${APP_SRV_ORIGIN_X:-546.1}"
export APP_SRV_ORIGIN_Y="${APP_SRV_ORIGIN_Y:-622.3}"
